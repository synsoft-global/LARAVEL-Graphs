...
<div class="subnav-one text-right"> 
  ...
  @else
   <p class="mobile-text-left">  {{$text}}</p>
  @endif
</div>
           ...
           <div class="dropdown-menu p-0" role="menu">
            <form class="form-horizontal segment-filter-opt groups-date-dropdown m-0" role="form">
               ...
               <div class="row tight-inner-gutter previous-defaults my-0">
                ...
                <p class="ml-0">{{ __('messages.products.Compare_data_to') }}:<i class="fa fa-info-circle mx-2" aria-hidden="true"></i></p>
                </div> 
                <div class="col-4 pull-right pl-0 pr-0">
                <button id="{{(isset($order_detail) && $order_detail) ? 'clear_compare_detail' : 'clear_compare' }}"class="btn btn-danger_dummy clear-btn" type="button" value="false">
                  Clear
                </button>           
                 </div>
              </div>
              ...
              <div class="row tight-inner-gutter previous-defaults my-2">
                <div class="col-4 pl-0">
                   <button data-placement="top" data-toggle="popover" data-trigger="hover" data-content="Previous Period" data-tippy-placement="top" id="{{(isset($order_detail) && $order_detail) ? 'date_comapare' : 'date_comapare_list' }}" value="period" class="btn btn-outline-secondary period-btn" type="button">
                        Period
                      </button>              
                </div> 
                <div class="col-8">
